...
#Load assets
RED_AGENT = pygame.image.load(os.path.join("Pygame_Simulation\\assets","pixel_ship_red_small.png"))
#Lasers
RED_LASER = pygame.image.load(os.path.join(
	"Pygame_Simulation\\assets","pixel_laser_red.png"))
#Backgrond
BG = pygame.transform.scale(pygame.image.load(os.path.join("Pygame_Simulation\\assets","background-black.png")),(WIDTH,HEIGHT))
